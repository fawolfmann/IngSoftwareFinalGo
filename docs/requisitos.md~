...
1. Requisito 1: Solo se pueda crear una instancia del modelo creado.
2. Requisito 2: puede que el producto reproduzca sonidos.
3. Requisito 3: El producto debe tener un contador de tiempo
4. Requisito 4: se debe poder ejecutar varios modelos al mismo tiempo.
5. Requisito 5: se debe poder volver a empezar el juego cuando se finaliza una pregunta.
6. Requisito 6: se tiene que poder contar la cantidad de veces que se instancia la modelo del corazon.
7. Requisito 7: el modelo debe proveer alguna forma de poder modificar las vistas en tiempo de ejecucion.
